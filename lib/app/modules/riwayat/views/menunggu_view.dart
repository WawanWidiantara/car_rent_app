                        ...
                        child: SizedBox(
                          ...
                          child: RefreshIndicator(
                            ...
                            child: ListView.builder(
                              itemCount: riwayatC.pendingHistoryList.isEmpty
                                  ? 1
                                  : riwayatC.pendingHistoryList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return Padding(
                                  padding: const EdgeInsets.only(bottom: 10),
                                  child: riwayatC.pendingHistoryList.isEmpty
                                      ? SizedBox(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            "INVOICE : ${riwayatC.pendingHistoryList[index].id.toString()}",
                                                            style: const TextStyle(
                                                                fontSize: 12,
                                                                fontWeight:
                                                                    FontWeight
